...
void Obstacle(void){
  ...
  while(a)
  {
    ...
    MAG_target_3 = MAG_start;

    sprintf((char*)txt,"M1:%06d",MAG_target);
    OLED_P6x8Str(5,7,(uint8_t*)txt);    
    sprintf((char*)txt,"M2:%06d",MAG_target_2);
    OLED_P6x8Str(70,7,(uint8_t*)txt);
...
/*
  if(double_flag==1){
    temp_double = temp_double + ABGet_left + ABGet_right;
    if(temp_double > 50){
      temp_double=0;double_flag=0;
    }
  }*/
...
void Part_Choose(void)
{
    switch(part_flag){
        ...
        case 11:Target_speed = 30; UART_PutStr(UART1, "#000P1503T0000!");Positioning();UART_PutBuff(UART3, scan_up, 7);step_flag = 1;PIT_Delayms(PIT3, 5000);Target_speed = 20;break;
        case 12:Target_speed = 20; UART_PutStr(UART1, "#000P1503T0000!");Positioning();UART_PutBuff(UART3, scan_down, 7);step_flag = 2;PIT_Delayms(PIT3, 5000);Target_speed = 20;break;
        case 13:Target_speed = 20; UART_PutStr(UART1, "#000P1503T0000!");Positioning();UART_PutBuff(UART3, scan_up, 7);step_flag = 3;PIT_Delayms(PIT3, 5000);Target_speed = 50;Pos_flag_2();UART_PutBuff(UART3, smooth, 7);step_flag = 2;break;
        ...
        case 21:Target_speed = 30; UART_PutStr(UART1, "#000P1507T0000!");Positioning();UART_PutBuff(UART3, scan_up, 7);step_flag = 1;PIT_Delayms(PIT3, 5000);Target_speed = 30;break;
        case 22:Target_speed = 30; UART_PutStr(UART1, "#000P1507T0000!");Positioning();UART_PutBuff(UART3, scan_down, 7);step_flag = 2;PIT_Delayms(PIT3, 5000);Target_speed = 30;break;
        ...
        case 26:Target_speed = 30; UART_PutStr(UART1, "#000P1507T0000!");Positioning();UART_PutBuff(UART3, scan_up, 7);step_flag = 3;PIT_Delayms(PIT3, 5000);Target_speed = 50;UART_PutBuff(UART3, smooth, 7);break;
