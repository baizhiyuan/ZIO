...
void Part_Choose(void)
{
    switch(part_flag){
        ...
        case 13:Target_speed = 30; Positioning();UART_PutBuff(UART3, arm, 7);step_flag = 3;delayms(8000);Target_speed = 80;step_flag = 2;break;
        case 3:break;
              //Obstacle();break;//避障区域
